using HqPocket.Extensions.Communications.Ports.Helpers;
...
{
    public class SerialPortCommunicator : CommunicatorBase, ISerialPortCommunicator
    {
        ...
        public SerialPortCommunicator(IOptions<SerialPortCommunicatorOptions> options) : base(options.Value)
        {
