...
public static class UdpClientCommunicatorServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddUdpClientCommunicator(this IServiceCollection services, Action<UdpClientCommunicatorOptions> setupAction)
    {
        ArgumentNullException.ThrowIfNull(services);
    ...
    public static IServiceCollection AddUdpClientCommunicator<TProtocol>(this IServiceCollection services, Action<UdpClientCommunicatorOptions> setupAction)
        where TProtocol : IProtocol
    {
        ArgumentNullException.ThrowIfNull(services);
        ArgumentNullException.ThrowIfNull(setupAction);
    ...
    public static IServiceCollection AddUdpClientCommunicator<TProtocol, TData>(this IServiceCollection services, Action<UdpClientCommunicatorOptions> setupAction)
        where TProtocol : IProtocol
        where TData : class
    {
        ArgumentNullException.ThrowIfNull(services);
