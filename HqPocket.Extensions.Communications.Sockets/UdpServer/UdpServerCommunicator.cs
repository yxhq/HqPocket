using HqPocket.Extensions.Communications.Sockets.Helpers;
...
namespace HqPocket.Extensions.Communications.Sockets
{
    public class UdpServerCommunicator : CommunicatorBase
    {
        ...
        protected UdpServerCommunicatorOptions Options { get; }
        ...
        public UdpServerCommunicator(IOptions<UdpServerCommunicatorOptions> options) : base(options.Value)
        {
