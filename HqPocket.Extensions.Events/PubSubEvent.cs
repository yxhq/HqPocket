    ...
    public virtual SubscriptionToken Subscribe(Action action, ThreadOption threadOption, bool keepSubscriberReferenceAlive)
    {
        ...
        switch (threadOption)
        {
            ...
            case ThreadOption.UIThread:
                if (SynchronizationContext is null) throw new InvalidOperationException(InternalResources.EventAggregatorNotConstructedOnUIThread);
...
public class PubSubEvent<TPayload> : EventBase
{
    ...
    {
        IDelegateReference actionReference = new DelegateReference(action, keepSubscriberReferenceAlive);
        IDelegateReference filterReference = filter is not null
