...
public static class TcpServerCommunicatorServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddTcpServerCommunicator(this IServiceCollection services, Action<SocketCommunicatorOptions> setupAction)
    {
        ArgumentNullException.ThrowIfNull(services);
    ...
    public static IServiceCollection AddTcpServerCommunicator<TProtocol>(this IServiceCollection services, Action<SocketCommunicatorOptions> setupAction)
        where TProtocol : IProtocol
    {
        ArgumentNullException.ThrowIfNull(services);
        ArgumentNullException.ThrowIfNull(setupAction);
    ...
    public static IServiceCollection AddTcpServerCommunicator<TProtocol, TData>(this IServiceCollection services, Action<SocketCommunicatorOptions> setupAction)
        where TProtocol : IProtocol
        where TData : class
    {
        ArgumentNullException.ThrowIfNull(services);
