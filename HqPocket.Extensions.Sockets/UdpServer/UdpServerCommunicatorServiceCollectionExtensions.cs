...
public static class UdpServerCommunicatorServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddUdpServerCommunicator(this IServiceCollection services, Action<SocketCommunicatorOptions> setupAction)
    {
        ArgumentNullException.ThrowIfNull(services);
    ...
    public static IServiceCollection AddUdpServerCommunicator<TProtocol>(this IServiceCollection services, Action<SocketCommunicatorOptions> setupAction)
        where TProtocol : IProtocol
    {
        ArgumentNullException.ThrowIfNull(services);
        ArgumentNullException.ThrowIfNull(setupAction);
    ...
    public static IServiceCollection AddUdpServerCommunicator<TProtocol, TData>(this IServiceCollection services, Action<SocketCommunicatorOptions> setupAction)
        where TProtocol : IProtocol
        where TData : class
    {
        ArgumentNullException.ThrowIfNull(services);
