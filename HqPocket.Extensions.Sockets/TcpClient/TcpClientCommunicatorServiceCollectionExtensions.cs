...
public static class TcpClientCommunicatorServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddTcpClientCommunicator(this IServiceCollection services, Action<SocketCommunicatorOptions> setupAction)
    {
        ArgumentNullException.ThrowIfNull(services);
    ...
    public static IServiceCollection AddTcpClientCommunicator<TProtocol>(this IServiceCollection services, Action<SocketCommunicatorOptions> setupAction)
        where TProtocol : IProtocol
    {
        ArgumentNullException.ThrowIfNull(services);
        ArgumentNullException.ThrowIfNull(setupAction);
    ...
    public static IServiceCollection AddTcpClientCommunicator<TProtocol, TData>(this IServiceCollection services, Action<SocketCommunicatorOptions> setupAction)
        where TProtocol : IProtocol
        where TData : class
    {
        ArgumentNullException.ThrowIfNull(services);
