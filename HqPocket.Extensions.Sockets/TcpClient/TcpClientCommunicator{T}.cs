...
public class TcpClientCommunicator<TProtocol> : TcpClientCommunicator, ICommunicator<TProtocol> where TProtocol : IProtocol
{
    ...
    public TcpClientCommunicator(IOptions<SocketCommunicatorOptions> options) : base(options)
    {
    }
