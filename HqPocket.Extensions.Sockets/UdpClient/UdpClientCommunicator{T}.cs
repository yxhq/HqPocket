...
public class UdpClientCommunicator<TProtocol> : UdpClientCommunicator, ICommunicator<TProtocol> where TProtocol : IProtocol
{
    ...
    public UdpClientCommunicator(IOptions<SocketCommunicatorOptions> options) : base(options)
    {
    }
